...
Module mdlBaseConversion
    Public frmbc As New frmBaseConverter
    Public Const beyondTen = "ABCDEFGHIJKLMNOPQRSTUVWXYZ!@#$%^&*(){}[]|/\:<>?,';"
    ...
    Private Function DigitCount(ByVal num As Double, ByVal base As Integer)
        ...
        Next i
        DigitCount = i
        'num = frmbc.txtInput.Text
    End Function
    Public Function Decimalize(ByVal input As Integer, ByVal inbase As Integer)
        Dim dig(100) As Integer, bound As Integer, i As Integer, Tenbase As Integer
